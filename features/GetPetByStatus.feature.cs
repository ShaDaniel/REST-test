...
#line hidden
        ...
        [NUnit.Framework.DescriptionAttribute("Положительный тест: 3 статуса питомца")]
        [NUnit.Framework.CategoryAttribute("280320201827")]
        [NUnit.Framework.CategoryAttribute("pos")]
        public virtual void ПоложительныйТест3СтатусаПитомца()
        {
            string[] tagsOfScenario = new string[] {
                    "280320201827",
                    "pos"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Положительный тест: 3 статуса питомца", null, new string[] {
                        "280320201827",
                        "pos"});
#line 5
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Негативный тест: 3 статуса питомца")]
        [NUnit.Framework.CategoryAttribute("280320201828")]
        [NUnit.Framework.CategoryAttribute("neg")]
        public virtual void НегативныйТест3СтатусаПитомца()
        {
            string[] tagsOfScenario = new string[] {
                    "280320201828",
                    "neg"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Негативный тест: 3 статуса питомца", null, new string[] {
                        "280320201828",
                        "neg"});
#line 11
this.ScenarioInitialize(scenarioInfo);
...
#line hidden
#line 13
 testRunner.And("get pet by status \"123\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "* ");
#line hidden
#line 14
 testRunner.And("get pet by status \"SolD\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "* ");
#line hidden
